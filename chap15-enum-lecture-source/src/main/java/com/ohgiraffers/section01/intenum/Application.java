...
public class Application {
    ...
    public static void printSubject(int num1) {
        ...
        switch (num1) {
            case Subjects.JAVA : subjectText1 = "JAVA"; break;
            case Subjects.JDBC : subjectText1 = "JDBC"; break;
            case Subjects.ORACLE : subjectText1 = "ORACLE"; break;
        }

        System.out.println("subject : " + subjectText1);
    }
}
