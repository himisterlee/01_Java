...
public class Application2 {
    public static void main(String[] args) {
        ...
        System.out.println("uijeong" + 123); // 정수와의 연산
        System.out.println("uijeong" + 123.456); //실수와의 연산
        System.out.println("uijeong" + 'a'); // 문자와의 연산
        System.out.println("uijeong" + true); // 논리값과의 연산

        // 주의해야할 점 숫자로된 문자열 형태의 값도 + 연산을 했을때 문자열 합치기가 된다.
